 ...
 * wall. The right corner of the robot must be against the wall, just ot the left of the tile separation
 * line.
...
*/
@Autonomous (name = "Blue PARK", group = "10841 blue")
//@Disabled
public class AutonomousBlue_LaunchAndPark extends LinearOpMode {
    ...
    void showData(){
        ...
        telemetry.addData("left drive motor speed = ", robot.leftDriveMotor.getPower());
        telemetry.addData("right drive motor speed = ", robot.rightDriveMotor.getPower());
        telemetry.update();
